...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Dvooskid001',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Ikakabasi Ntuen</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://edetdavid.vercel.app/" style="text-decoration: none; color: grey;">Dvooskid</a> through 
            <a href="https://www.linkedin.com/in/edet-david-b2a85a266/" style="text-decoration: none; color: grey;">Dvooskid --(Software Engineer)</a>
        </p>
